                                    ...
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                      <div class="row">
                                        <div class="col-12 col-md-8">
                                         <form method="POST" action="promote_student.php">
                                            <div class="row">
                                                    ...
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                          <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                            <input type="text" name="search" class="form-control" placeholder="Enter Matric Number">
                                                        </div>
                                                      </div>
                                                  </div>
                                                  <div class="row">
                                                    ...
                                                    <div class="review-content-section">
                                                      ...
                                                      <div class="review-content-section">
                                                       ...
                                                       <div class="input-group mg-b-pro-edt" style="padding-left: 15px; padding-right: 15px">
                                                        <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                       <select required="" name="class" class="form-control pro-edt-select form-control-primary">
                                                            <option value="ND I<?php if($class=="ND I") echo '"selected"'; ?>">ND I</option>
                                                            <option value="ND II<?php if($class=="ND II") echo '"selected"'; ?>">ND II</option>
                                                        </select>
                                                    </div>
                                                      <div class="row">
                                                    <div class="text-center custom-pro-edt-ds">
