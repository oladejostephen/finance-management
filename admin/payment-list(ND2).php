...
$selectpayment2 = mysqli_query($db, "SELECT * FROM user WHERE matric = '".$_SESSION['matric']."' ");
        while ($rowpayment2 = mysqli_fetch_array($selectpayment2)) {
            ...
            $email = $rowpayment2['email'];
        }    
$fetch = mysqli_query($db, "SELECT * FROM payment WHERE payment_year = 'ND II' AND payment_semester = 'First Semester'");
$fetch2 = mysqli_query($db, "SELECT * FROM payment WHERE payment_year = 'ND II' AND payment_semester = 'Second Semester'");
                                                    ...
                                                    <div class="review-content-section">
                                                       <table>                                    
                                                            ...
                                                            <tr>                                    
                                                                ...
                                                                <td>
                                                                    <button disabled="" class="pd-setting"><?php echo $row['payment_status']?></button>
                                                                </td>
                                                               <td>
                                                        ...
                                                        <table>                                    
                                                            ...
                                                            <tr>                                    
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button href="#" data-toggle="modal" data-target="#DeleteModal2<?php echo $id ?>" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                                </td>
                                                            </tr>
