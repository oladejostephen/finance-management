        ...
        <?php
            if ($fetch000->num_rows>0) {
                while ($row000=mysqli_fetch_array($fetch000)) {
                    ...
                    ?> 
          <tr id="de">  
                <td id="de" style="text-transform: uppercase;"><?php echo $bs ?></td>
                <td id="de" style="text-transform: uppercase;"><?php echo $ba ?></td>
                <td id="de"><?php echo $id ?></td>
                <td id="de" style="text-transform: uppercase;"><?php echo $bd ?></td>
                ...
                <td id="de">#<?php echo $bz ?>.00</td>
                <td id="de"><?php echo $bn ?></td>
                <td id="de"><?php echo $bm ?></td>
          </tr>
           <?php
                            }
                        }
